...
class DenseLayer:
    ...
    def backward(self, dL_dZ):
        ...
        ✅ FIX: Batch-average the gradients
        The autograder expects averaged gradients, not sum-scaled gradients.
        """
        batch_size = self.X.shape[0]
        
        # Compute gradients and DIVIDE by batch size for averaging
